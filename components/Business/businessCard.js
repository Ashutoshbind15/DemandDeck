...
export default function BusinessCard() {
  return (
    <div className="card md:card-side bg-base-100 shadow-xl w-[600px] mx-auto my-8">
      <div className="bg-red-500 md:w-1/5 px-4 text-center rounded-l-2xl flex justify-center items-center">
        <h1 className="text-2xl font-bold">Amul Milk Services</h1>
      </div>
